...
class PointageListController extends ListController {
    ...
    async modalPrint(data) {
        ...
        $('#myForm').on('submit', (event) => {
                ...
                .then((data) => {
                    ...
                    if (data.status === 204) {
                        ...
                        data.json().then(async res => {
                            ...
                            res.forEach(async (emp) => {
                                const finalemp = emp
                                content_report_pointage_salarie(finalemp).then(content => pdfContent.push(content))
                            });
            ...
            /*this.http
                .post('./hr_management/get_report_pointage/', selectedValues)
                .then((data) => {
